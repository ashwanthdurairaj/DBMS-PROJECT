...
class App:
    def __init__(self, root):
        ...
        GMessage_47["text"] = "TEAM BOWLING"
        GMessage_47.place(x=50,y=30,width=148,height=34)
        ...
        GMessage_75["text"] = "TEAM BATTING"
        GMessage_75.place(x=410,y=30,width=193,height=34)
